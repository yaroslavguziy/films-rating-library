...
function parseNumberSkeletonFromString(skeleton) {
    ...
    var stringTokens = skeleton
        .split(regex_generated.WHITE_SPACE_REGEX)
    ...
    Parser.prototype.parseArgumentOptions = function (nestingLevel, expectingCloseTag, value, openingBracePosition) {
        ...
        switch (argType) {
            ...
            case 'select': {
                ...
                this.bumpSpace();
                if (!this.bumpIf(',')) {
                    return this.error(error.ErrorKind.EXPECT_SELECT_ARGUMENT_OPTIONS, createLocation(typeEndPosition_1, tslib_es6.__assign({}, typeEndPosition_1)));
                }
                this.bumpSpace();
                // Parse offset:
...
function parse(message, opts) {
    if (opts === void 0) { opts = {}; }
    opts = tslib_es6.__assign({ shouldParseSkeletons: true }, opts);
...
function formatMessage$1(_a, state, messageDescriptor, values, opts) {
    ...
    if (Array.isArray(message) &&
        message.length === 1 &&
        message[0].type === icuMessageformatParser.TYPE.literal) {
...
function createIntl$1(config, cache) {
    ...
    return __assign(__assign({}, resolvedConfig), { formatters: formatters, formatNumber: formatNumber.bind(null, resolvedConfig, formatters.getNumberFormat), formatNumberToParts: formatNumberToParts.bind(null, resolvedConfig, formatters.getNumberFormat), formatRelativeTime: formatRelativeTime.bind(null, resolvedConfig, formatters.getRelativeTimeFormat), formatDate: formatDate.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatDateToParts: formatDateToParts.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatTime: formatTime.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatDateTimeRange: formatDateTimeRange.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatTimeToParts: formatTimeToParts.bind(null, resolvedConfig, formatters.getDateTimeFormat), formatPlural: formatPlural.bind(null, resolvedConfig, formatters.getPluralRules), formatMessage: formatMessage$1.bind(null, resolvedConfig, formatters), formatList: formatList.bind(null, resolvedConfig, formatters.getListFormat), formatDisplayName: formatDisplayName.bind(null, resolvedConfig, formatters.getDisplayNames) });
}
